...
public class Examen1 {
	...
	public Examen1() {
		...
		ConexionBBDDExamen1.crearConexion();
		initialize();
	}
	...
	private void initialize() {
		...
		btnIrAPreg.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				lblPreg.setText(ConexionBBDDExamen1.siguientePregunta(contador));
				LblrespA.setText(ConexionBBDDExamen1.sigRespA(contador));
				LblrespB.setText(ConexionBBDDExamen1.sigRespB(contador));
				LblrespC.setText(ConexionBBDDExamen1.sigRespC(contador));
				LblrespD.setText(ConexionBBDDExamen1.sigRespD(contador));
				btnIrAPreg.setEnabled(false);
			}
		});
		btnIrAPreg.setBounds(10, 616, 244, 23);
		...
		PanRespError.setBounds(186, 553, 68, 52);
		...
		txtIrAPreg.setBounds(109, 585, 40, 20);
		...
		BtnRepetir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				ExamenRecuperacion eR = new ExamenRecuperacion();
				 frmExamen.dispose();
		...
		frmExamen.getContentPane().add(BtnRepetir);
						...
						lblNewLabel.setBounds(98, 560, 77, 14);
	...
	private void funccionRadioButon() {
		if (ConexionBBDDExamen1.comprobarResp(contador).equals(letra)) {
			contador++;
			...
			lblCorPreg.setText(ConexionBBDDExamen1.siguientePregunta(contador));
