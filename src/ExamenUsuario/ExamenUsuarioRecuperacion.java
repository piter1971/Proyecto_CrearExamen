...
public class ExamenUsuarioRecuperacion {
	...
	public ExamenUsuarioRecuperacion() {
	...
	private void initialize() {
		...
		frmExamenDeRecuperacion.setTitle("Examen_Usuario de Recuperacion");
		...
		btnOk.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (contador < list.size() - 1) {
					...
					lblCorPreg.setText("");
					lblCorResp.setText("");
					lblPreg.setText(ConexionBBDDExamenUsuario.siguientePregunta((int) list.get(contador)));
					LblrespA.setText(ConexionBBDDExamenUsuario.sigRespA((int) list.get(contador)));
					LblrespB.setText(ConexionBBDDExamenUsuario.sigRespB((int) list.get(contador)));
					LblrespC.setText(ConexionBBDDExamenUsuario.sigRespC((int) list.get(contador)));
					LblrespD.setText(ConexionBBDDExamenUsuario.sigRespD((int) list.get(contador)));
					rBa.setEnabled(true);
					rBb.setEnabled(true);
					rBc.setEnabled(true);
					rBd.setEnabled(true);
					...
					LblrespC.setText("");
					LblrespD.setText("");
					if (ExamenUsuario.PuntuacionMal != 0) {
		...
		LblrespA.setText(ConexionBBDDExamenUsuario.sigRespA((int) list.get(0)));
		...
		LblrespB.setText(ConexionBBDDExamenUsuario.sigRespB((int) list.get(0)));
		...
		LblrespC.setText(ConexionBBDDExamenUsuario.sigRespC((int) list.get(0)));
		...
		LblrespD.setText(ConexionBBDDExamenUsuario.sigRespD((int) list.get(0)));
		...
		lblPreg.setText(ConexionBBDDExamenUsuario.siguientePregunta((int) list.get(0)));
		...
		labelMal = new JLabel(String.valueOf(ExamenUsuario.PuntuacionMal));
	...
	private void funcionRadioButton() {
		if (ConexionBBDDExamenUsuario.comprobarResp((int) list.get(contador)).equals(letra)) {// if 1 comporbar respuesta
			ExamenUsuario.PuntuacionMal--;
			PuntuacionBien++;
			labelBien.setText(String.valueOf(PuntuacionBien));
			labelMal.setText(String.valueOf(ExamenUsuario.PuntuacionMal));
			...
			lblCorPreg.setText(ConexionBBDDExamenUsuario.siguientePregunta((int) list.get(contador)));
